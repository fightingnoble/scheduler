...
nohup python allocator_agent.py  --test_case bin_pack_new --num_cores 266 --n_p 3 > log/bin_pack_new_266.log.txt 2>&1 &
...
nohup python allocator_agent.py  --test_case bin_pack_new --num_cores 256 --n_p 3 > log/bin_pack_new_256.log.txt 2>&1 &
wait
...
wait &&\
python log_analyse.py --folder ./log/ --output ./log/new_bin_pack256.csv