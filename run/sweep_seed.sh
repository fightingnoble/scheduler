...
nohup ./run/exp_cmd_min_core.sh barycenter/core_scan True True True True 0 $PY_ARGS > log/barycenter/core_scan/cmd.log.txt 2>&1
# ./run/exp_cmd_max_tp.sh 0 25 200 0 1 9  True True True True barycenter/aux_scan 0 $PY_ARGS &
nohup ./run/exp_cmd_max_tp.sh 0 25 200 0 1 9  True True True True barycenter/aux_scan 0 $PY_ARGS > log/barycenter/aux_scan/cmd.log.txt 2>&1&
