...
def glb_alloc_new(process_dict, quantum_check_en, quantumSize, timestep, exec_t_comp_ratioA, ready_queue, running_queue, rsc_recoder, 
                  ...
                  DEBUG_FG=False, 
                  show_warnings=True, 
                  binpack_cfg:Dict={"sort":"EAT", "mode": 'scratch'},
                  ):
    # =================================================
...
def allocate_rsc_4_process_new(_p:ProcessInt, n_slot:int, 
    ...
    # case 3: allocateable by preempting tasks with **enough resources and lower priority**, state is False, but fail_info is not None
