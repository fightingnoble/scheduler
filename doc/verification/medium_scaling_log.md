...
Lane_drivable_area_det TaskIntAttr(name='Lane_drivable_area_det', freq=20, timing_flag='realtime', criticality='soft', trigger_mode='N', core_max=1000.0, core_min=0, core_list=None, parallel_mode=None, core_max_compile=1000.0, core_min_compile=0, core_list_compile=None, thread_scaling_factor=4, freq_division_factor=2, var_factor=1, jitter_max=0, ERT=0.057962238727285016, ddl=0.04203776127271499, exp_comp_t=0.03993587320907924, flops=0.1285636, task_flag='moveable', pre_assigned_resource_flag=True, num_exec=8, no_stall_latency=0.036732457142857146, min_tot_rsc=56, max_tot_rsc=56, flops_ModelSum=1.0285088, flops_max=1.0285088, equiv_core=20.570176, util=0.36732457142857144, main_size=7, rda_size=0)

Optical_Flow TaskIntAttr(name='Optical_Flow', freq=20, timing_flag='realtime', criticality='soft', trigger_mode='N', core_max=1000.0, core_min=0, core_list=None, parallel_mode=None, core_max_compile=1000.0, core_min_compile=0, core_list_compile=None, thread_scaling_factor=4, freq_division_factor=2, var_factor=1, jitter_max=0, ERT=0.057962238727285016, ddl=0.04203776127271502, exp_comp_t=0.03993587320907926, flops=0.079514, task_flag='moveable', pre_assigned_resource_flag=False, num_exec=8, no_stall_latency=0.039757, min_tot_rsc=32, max_tot_rsc=32, flops_ModelSum=0.636112, flops_max=0.636112, equiv_core=12.72224, util=0.39757, main_size=4, rda_size=0)

Depth_estimation TaskIntAttr(name='Depth_estimation', freq=20, timing_flag='realtime', criticality='soft', trigger_mode='N', core_max=1000.0, core_min=0, core_list=None, parallel_mode=None, core_max_compile=1000.0, core_min_compile=0, core_list_compile=None, thread_scaling_factor=4, freq_division_factor=2, var_factor=1, jitter_max=0, ERT=0.057962238727285016, ddl=0.04203776127271499, exp_comp_t=0.03993587320907924, flops=0.0642818, task_flag='moveable', pre_assigned_resource_flag=False, num_exec=8, no_stall_latency=0.0321409, min_tot_rsc=32, max_tot_rsc=32, flops_ModelSum=0.5142544, flops_max=0.5142544, equiv_core=10.285088, util=0.321409, main_size=4, rda_size=0)
